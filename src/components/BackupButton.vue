  ...
  <div class="mt-10 p-4 border-t border-white/5">
    ...
    <div class="space-y-3">
      <button @click="copyToClipboard" 
        class="w-full bg-blue-500/10 border border-blue-500/20 text-blue-400 p-4 rounded-xl flex items-center justify-between active:scale-95 transition">
      ...
      <button @click="importFromText" 
        class="w-full bg-gray-800 border border-white/5 text-gray-300 p-4 rounded-xl flex items-center justify-between active:scale-95 transition">
        <div class="flex items-center gap-3">
